...
public class OFLoom : MonoBehaviour
{
    //是否已经初始化
    static bool isInitialized;

    private static OFLoom _ins;
    public static OFLoom ins { get { Initialize(); return _ins; } }
    ...
    public static void Initialize()
    {
        if (!isInitialized)
        {
            ...
            isInitialized = true;
            var obj = new GameObject("OFLoom");
            _ins = obj.AddComponent<OFLoom>();
    ...
    //加入到主线程执行队列（无延迟）
    public static void QueueOnMainThread(Action<object> taction, object param = null)
    {
