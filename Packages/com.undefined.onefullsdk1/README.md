...
<root>
  ...
  ├── Editor
  │   ├── Undefined.Onefullsdk1.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.Onefullsdk1.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.Onefullsdk1.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.Onefullsdk1.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.Onefullsdk1`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package OneFullSDK 1 Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.Onefullsdk1.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.Onefullsdk1.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.Onefullsdk1.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.Onefullsdk1.Tests.asmdef`
...
Use the `Documentations~/OneFullSDK 1.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
